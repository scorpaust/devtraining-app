...
export const dataSource = new DataSource({
    ...
    synchronize: false,
    migrations: [CreateCourseTable1666879106427, CreateTagsTable1666880364309, CreateCoursesTagsTable1666882042291,
    AddCoursesIdToCoursesTagsTable1666882439552, AddTagsIdToCoursesTagsTable1666882966033],
});